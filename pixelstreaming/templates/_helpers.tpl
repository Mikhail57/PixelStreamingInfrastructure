...
{{ include "pixelstreaming.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "pixelstreaming.selectorLabels" -}}
...
*/}}
{{- define "pixelstreaming.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "pixelstreaming.fullname" .) .Values.serviceAccount.name }}
{{- else }}
